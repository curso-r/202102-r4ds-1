...
### titulo de terceira ordem
#### titulo de quarta ordem
...
# Subir dois níveis de diretório
# "../../"

# opcao com o pacote here

# imdb <- read_rds(here::here("dados", "imdb.rds"))
```
...
```{r, fig.align = "center", warning = FALSE, fig.cap="Figura 1. Nota média ao longo dos anos.", out.width="100%" }
imdb %>% 
  group_by(ano) %>% 
